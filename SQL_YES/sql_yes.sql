/*
 ...
 Source Schema         : sql_yes

 Target Server Type    : MySQL
 Target Server Version : 50726
 File Encoding         : 65001

 Date: 03/05/2021 13:52:04
*/
...
CREATE TABLE `customers`  (
  `cust_id` char(10) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
-- Records of orders
-- ----------------------------
INSERT INTO `orders` VALUES (20005, '2020-05-01 00:00:00', '1000000001');
INSERT INTO `orders` VALUES (20006, '2020-01-12 00:00:00', '1000000003');
INSERT INTO `orders` VALUES (20007, '2020-01-30 00:00:00', '1000000004');
INSERT INTO `orders` VALUES (20008, '2020-02-03 00:00:00', '1000000005');
INSERT INTO `orders` VALUES (20009, '2020-02-08 00:00:00', '1000000001');
...
CREATE TABLE `products`  (
  `prod_id` char(10) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `vend_id` char(10) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
